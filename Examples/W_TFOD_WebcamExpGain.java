 ...
 * 
 * This OpMode simply adds ExposureControl and GainControl methods to the
 ...
 * 
 * Improved exposure and gain values, if any, could be pre-programmed in team
 * autonomous OpModes.  It's also possible to manually enter such values before
 * a match begins, based on anticipated lighting, starting position and other 
 * game-time factors.
 * 
