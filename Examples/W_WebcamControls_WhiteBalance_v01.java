...
public class W_WebcamControls_WhiteBalance_v01 extends LinearOpMode {
    ...
    double tempIncrement = 100;       // for manual gamepad adjustment
    ...
    @Override public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            wasTemperatureSet = myWBControl.setWhiteBalanceControl(curWhiteBalanceTemp);
